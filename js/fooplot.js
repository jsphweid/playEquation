  ...
  this.zoom=function(factor) {
    ...
    if(FOOPLOT_TRANSITIONS && this.canvas && this.canvas.style && factor!=1) {
      ...
      this.zoomTimeout=window.setTimeout(function(_self) {
        ...
        _self.ymax=(_self.ymax-centery)/_self.zoomPendingFactor+centery; // commented out because I don't want y to change
        _self.ymin=(_self.ymin-centery)/_self.zoomPendingFactor+centery; // commented out because I don't want y to change
